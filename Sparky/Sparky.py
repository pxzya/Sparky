...
//|Shout out to Duckify and Spacehuhn.|
//|Code by github.com/SpacehuhnTech   |
//|            .-------.              |
//|         By | PXZYA |              |
//|            '-------'              |
//+-----------------------------------+
""")
    ...
    output.append('')
    output.append('// Created using Sparky by PXZYA')
...
class sparklingGUI:
    def __init__(self, root):
        ...
        self.name_var = tk.StringVar(value="sparkling_sketch")
